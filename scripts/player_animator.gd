...
const DIRECTION_SECTORS: Array[Array] = [
	...
	[-180.0, -157.5, "idle_up_side", true],
	[-157.5, -112.5, "idle_up", false],
	[-112.5, -67.5, "idle_up_side", false],
	[-67.5, -22.5, "idle_side", false],
	[-22.5, 22.5, "idle_down_side", false],
	[22.5, 67.5, "idle_down", false],
	[67.5, 112.5, "idle_down_side", true],
	[112.5, 157.5, "idle_side", true],
	[157.5, 180.0, "idle_up_side", true]
]
...
func set_direction(direction: Vector2) -> void:
	...
	if animation_data[0] != current_animation:
		current_animation = animation_data[0]
		sprite.play(current_animation)
...
func get_animation_for_angle(angle: float) -> Array:
	...
	return ["idle_up_side", true] # Fallback (should never be reached)
